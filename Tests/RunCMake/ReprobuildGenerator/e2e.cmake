...
elseif(TEST_MODE STREQUAL "multi_config_debug_release")
  ...
  foreach(expected IN ITEMS
      ...
      "action: link-app-Debug status=asSucceeded launched=true")
    assert_contains("${debug_output}" "${expected}" "Debug multi-config build output")
  endforeach()
  foreach(expected IN ITEMS
      "selectedTarget: app:Release"
      "action: link-app-Release status=asSucceeded launched=true")
...
elseif(TEST_MODE STREQUAL "multi_config_target_selection")
  ...
  assert_contains("${selection_output}" "action: link-app-Debug status=asSucceeded launched=true" "multi-config selection output")
  ...
  assert_contains("${order_output}" "action: link-app-Release status=asSucceeded launched=true" "default-order build output")
